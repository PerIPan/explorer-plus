      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="bg-[var(--surface-card)] border border-[var(--border-color)] rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            {!isAtlas && <Link href="/groups" className="text-xs text-[var(--accent-orange)] hover:underline">View all</Link>}
          </div>
          {topGroups.length > 0 ? (
        ...
        <div className="bg-[var(--surface-card)] border border-[var(--border-color)] rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            {!isAtlas && <Link href="/techniques" className="text-xs text-[var(--accent-teal)] hover:underline">View all</Link>}
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        <div className="bg-[var(--surface-card)] border border-[var(--border-color)] rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/tactics" className="flex items-center gap-1 text-xs text-[var(--text-secondary)] hover:text-[var(--accent-yellow)] transition-colors">
          ...
          {tacticDistribution.length > 0 ? (
            <TacticBarChart data={tacticDistribution} onBarClick={(tacticId) => router.push(`/tactics/${tacticId}`)} />
          ) : (
        ...
        <div className="bg-[var(--surface-card)] border border-[var(--border-color)] rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/sectors" className="flex items-center gap-1 text-xs text-[var(--text-secondary)] hover:text-[var(--accent-pink)] transition-colors">
