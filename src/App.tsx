          ...
          >
            ...
            <div className="px-6 py-5 space-y-4 text-sm text-[var(--text-primary)] leading-relaxed">
              ...
              <ul className="space-y-2 pl-4 list-disc marker:text-[var(--accent-teal)]">
                ...
                <li><strong>A2A Agent Protocol</strong> — AI agents can query this knowledge base programmatically via the <a href="/.well-known/agent-card.json" target="_blank" rel="noopener noreferrer" className="text-[var(--accent-teal)] hover:underline">Agent Card</a>. 13 skills, 50 req/day, no auth. Powered by Gemini</li>
