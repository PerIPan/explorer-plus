...
function makeNodes(c: ReturnType<typeof useThemeColors>): ModelNode[] {
  ...
  return [
    ...
    { id: 'nvd', label: 'NVD', x: 260, y: 640, color: '#38bdf8', bg: '#38bdf818', path: '/cti/cves', description: 'National Vulnerability Database — CVSS scores, CWE, descriptions', category: 'intelligence' },
    { id: 'report', label: 'Threat Reports', x: 280, y: 540, color: c.accentOrange, bg: alpha(c.accentOrange, '18'), path: '/cti/reports', description: 'Live threat intelligence from OTX, RSS feeds', category: 'intelligence' },
    { id: 'cve', label: 'CVEs', x: 420, y: 560, color: c.accentPink, bg: alpha(c.accentPink, '18'), path: '/cti/cves', description: 'Known vulnerabilities enriched with NVD metadata', category: 'intelligence' },
    { id: 'ioc', label: 'IOCs', x: 580, y: 560, color: '#fb923c', bg: '#fb923c18', path: '/cti/iocs', description: 'Hashes, domains, IPs from OTX, ThreatFox, MalwareBazaar', category: 'intelligence' },
    { id: 'virustotal', label: 'VirusTotal', x: 700, y: 640, color: '#3b82f6', bg: '#3b82f618', path: '/cti/iocs', description: 'Sandbox verdicts and ATT&CK techniques for file hashes', category: 'intelligence' },
    { id: 'atomic', label: 'Atomic Tests', x: 780, y: 540, color: '#ef4444', bg: '#ef444418', path: '/techniques', description: 'Red team test procedures per technique', category: 'intelligence' },
