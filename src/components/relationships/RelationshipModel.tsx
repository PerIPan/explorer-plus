...
function makeNodes(c: ReturnType<typeof useThemeColors>): ModelNode[] {
  ...
  return [
    ...
    { id: 'virustotal', label: 'VirusTotal', x: 750, y: 660, color: '#3b82f6', bg: '#3b82f618', path: '/cti/iocs', description: 'Sandbox verdicts and ATT&CK techniques for file hashes', category: 'intelligence' },
