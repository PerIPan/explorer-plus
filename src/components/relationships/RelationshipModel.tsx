...
function makeNodes(c: ReturnType<typeof useThemeColors>): ModelNode[] {
  ...
  return [
    ...
    { id: 'nvd', label: 'NVD', x: 260, y: 580, color: '#38bdf8', bg: '#38bdf818', path: '/cti/cves', description: 'National Vulnerability Database — CVSS scores, CWE, descriptions', category: 'intelligence' },
    ...
    { id: 'virustotal', label: 'VirusTotal', x: 680, y: 580, color: '#3b82f6', bg: '#3b82f618', path: '/cti/iocs', description: 'Sandbox verdicts and ATT&CK techniques for file hashes', category: 'intelligence' },
    { id: 'atomic', label: 'Atomic Tests', x: 750, y: 490, color: '#ef4444', bg: '#ef444418', path: '/techniques', description: 'Red team test procedures per technique', category: 'intelligence' },
