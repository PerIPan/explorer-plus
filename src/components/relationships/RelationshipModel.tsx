...
function makeNodes(c: ReturnType<typeof useThemeColors>): ModelNode[] {
  ...
  return [
    ...
    { id: 'cve', label: 'CVEs', x: 460, y: 560, color: c.accentPink, bg: alpha(c.accentPink, '18'), path: '/cti/cves', description: 'Known vulnerabilities enriched with NVD metadata', category: 'intelligence' },
    { id: 'ioc', label: 'IOCs', x: 600, y: 560, color: '#fb923c', bg: '#fb923c18', path: '/cti/iocs', description: 'Hashes, domains, IPs from OTX, ThreatFox, MalwareBazaar', category: 'intelligence' },
    { id: 'virustotal', label: 'VirusTotal', x: 160, y: 540, color: '#3b82f6', bg: '#3b82f618', path: '/cti/iocs', description: 'Sandbox verdicts and ATT&CK techniques for file hashes', category: 'intelligence' },
